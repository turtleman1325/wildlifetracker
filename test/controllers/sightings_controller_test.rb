...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { date: @sighting.date, latitude: @sighting.latitude, longitude: @sighting.longitude, species: @sighting.species }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { date: @sighting.date, latitude: @sighting.latitude, longitude: @sighting.longitude, species: @sighting.species }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
